...
function Header() {
  ...
  const cart = useSelector((state: RootState) => state.select);
  ...
  return (
    <header className="z-10 fixed flex-col md:flex-row gap-4 shadow-md bg-blue-300 text-gray-800 text-sm border-b border-gray-300 w-full xl:w-[calc(100%-256px)] xl:ml-64 flex items-center justify-between p-1.5">
      ...
      <nav className="flex items-center gap-2 text-sm">
        ...
        <Menu as="div">
          <Menu.Button className="flex items-center gap-4 hover:bg-gray-200 py-2 px-4 rounded-lg transition-colors">
            <img
              src={"https://res.cloudinary.com/dg2ugi96k/image/upload/v1701830124/feria_shirley/perfil_jhehx2.jpg"}
              alt={user.nombre}
              ...
              <div>
                <Menu.Item>
                  ...
                  >
                    ...
                    />
                    <div>
                      <h5 className="">{user.nombre}</h5>
                      <p className="text-gray-600 text-xs">{user.rol}</p>
