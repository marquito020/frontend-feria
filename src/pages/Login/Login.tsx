    ...
    <div className="min-h-screen bg-[#100e17] text-gray-900 flex items-center justify-center p-4">
      <div className="max-w-lg ">
        <div className="flex justify-center mb-8">
          <img src={"https://res.cloudinary.com/dg2ugi96k/image/upload/v1701847867/feria_shirley/WhatsApp_Image_2023-12-06_at_1.41.59_AM-removebg-preview_v219co.png"} alt="react logo" width={180} height={160} />
        </div>
