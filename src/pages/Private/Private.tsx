...
const Inverters = lazy(() => import("./Inverters"));
    ...
    <Routes>
      <Route element={<MainContent />}>
        ...
        <Route element={<ClientAuthorization />}>
          <Route path={PrivateRoutes.PANELES} element={<Panels />} />
          <Route path={PrivateRoutes.BATTERIES} element={<Batteries />} />
          <Route path={PrivateRoutes.INVERTERS} element={<Inverters />} />
