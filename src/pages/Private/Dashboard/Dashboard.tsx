    ...
    <>
      <div className=" bg-gray-50 flex items-center p-4 mt-16 rounded-lg">
        <section
          ...
          style={{
            backgroundImage: "url('https://res.cloudinary.com/dg2ugi96k/image/upload/v1701849625/feria_shirley/3821977_pa2yka.jpg')",
          }}
        >
          <div className="container mx-auto text-left text-white">
            <div className="flex items-center">
              <div className="w-1/2">
                <h1 className="text-6xl font-medium mb-6 ml-5">
                  Bienvenido!
                </h1>
                <p className="text-xl mb-12 ml-5">
                  Construyendo el futuro, Potenciando el presente
                </p>
              </div>
              <div className="w-1/2 pl-16">
                <img
                  src="https://res.cloudinary.com/dg2ugi96k/image/upload/v1701849720/feria_shirley/suciedad-y-polvo-rendimiento-placas-solares_m5hy81.jpg"
